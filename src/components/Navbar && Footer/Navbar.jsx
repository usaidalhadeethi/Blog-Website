...
export default function ResponsiveAppBar({ homeRef, blogRef, footerRef }) {
    const [anchorElNav, setAnchorElNav] = React.useState(null);
    ...
    const handleNavigation = (page) => {
        handleCloseNavMenu();
        let ref;
        if (page === 'Home') ref = homeRef;
        else if (page === 'Blog') ref = blogRef;
        else if (page === 'Footer') ref = footerRef;
